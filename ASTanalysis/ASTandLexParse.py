...
def saveToMongo(combinedVector, codedBy, filePath, rootFolder, parentFolder, filename, PathToPickleFile, ASTFolder):
    ...
    insertDocument = {"File_Name" : filename, "Coded_By" : codedBy, "Parent_Folder" : parentFolder, "File_Path" : filePath, "AST_Path" : PathToPickleFile, "AST_Dictionary" : ASTFolder, "Output_Vector" : inStringFormat, }
...
def main():
    ...
    cmdparser.add_argument('codeFile', help='Add absolute path to the file that needs to be parsed')
    cmdparser.add_argument('ASTDict', help='Add absolute path to the Bigram folder that needs to be parsed')
    ...
    saveToMongo(combinedVector, codedBy, filePath, rootFolder, parentFolder, filename, PathToPickleFile, ASTFolder)
