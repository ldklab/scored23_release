...
def createVector(finalList):
    ...
    for eachFile in finalList:
        ...
        insertDocument = {"File_Name" : fileName, "Coded_By" : codedBy, "Parent_Folder" : rootFolder, "Parent_Folder" : parentFolder, "File_Path" : filePath, "Output_Vector" : inStringFormat}
