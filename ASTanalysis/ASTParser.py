...
def printwithdfs_tree(nodelist, codeByfolder, datafolder, filename, codeBy, destPath, filePath):
    ...
    for parentNode in nodelist:
        ...
        insertDocument = {"File_Name" : filename, "File_Path" : filePath, "Coded_By" : codeBy, "Parent_Folder" : datafolder, "Root_Folder" : codeByfolder, "Node_ID" : parentNode, "Graph_Path" : finalpath, "XML_Graph" : str_subtree}
...
def main():
    ...
    cmdparser.add_argument('file', help='Add absolute path to the file that needs to be parsed')
    ...
    printwithdfs_tree(nxfnodes, codeByFolder, datafolder, filename, codeBy, destPath, filePath)
