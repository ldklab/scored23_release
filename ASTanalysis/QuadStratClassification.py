...
def classification(X,y):
    ...
    print('Mean Accuracy for KNN is %0.2f with a Standard Deviation of %0.2f' % (stratknn['test_accuracy'].mean(), stratknn['test_accuracy'].std()))
    print('Mean F1 Score for KNN is %0.2f with a Standard Deviation of %0.2f' % (stratknn['test_f1'].mean(), stratknn['test_f1'].std()))
    print('Mean Precision for KNN is %0.2f with a Standard Deviation of %0.2f' % (stratknn['test_precision'].mean(), stratknn['test_precision'].std()))
    print('Mean Recall for KNN is %0.2f with a Standard Deviation of %0.2f' % (stratknn['test_recall'].mean(), stratknn['test_recall'].std()))
    ...
    print('Mean Accuracy for RFC is %0.2f with a Standard Deviation of %0.2f' % (stratrfc['test_accuracy'].mean(), stratrfc['test_accuracy'].std()))
    print('Mean F1 Score for RFC is %0.2f with a Standard Deviation of %0.2f' % (stratrfc['test_f1'].mean(), stratrfc['test_f1'].std()))
    print('Mean Precision for RFC is %0.2f with a Standard Deviation of %0.2f' % (stratrfc['test_precision'].mean(), stratrfc['test_precision'].std()))
    print('Mean Recall for RFC is %0.2f with a Standard Deviation of %0.2f' % (stratrfc['test_recall'].mean(), stratrfc['test_recall'].std()))
    ...
    print('Mean Accuracy for SVM is %0.2f with a Standard Deviation of %0.2f' % (stratsvc['test_accuracy'].mean(), stratsvc['test_accuracy'].std()))
    print('Mean F1 Score for SVM is %0.2f with a Standard Deviation of %0.2f' % (stratsvc['test_f1'].mean(), stratsvc['test_f1'].std()))
    print('Mean Precision for SVM is %0.2f with a Standard Deviation of %0.2f' % (stratsvc['test_precision'].mean(), stratsvc['test_precision'].std()))
    print('Mean Recall for SVM is %0.2f with a Standard Deviation of %0.2f' % (stratsvc['test_recall'].mean(), stratsvc['test_recall'].std()))  
    ...
    print('Mean Accuracy for XGB is %0.2f with a Standard Deviation of %0.2f' % (stratxgb['test_accuracy'].mean(), stratxgb['test_accuracy'].std()))
    print('Mean F1 Score for XGB is %0.2f with a Standard Deviation of %0.2f' % (stratxgb['test_f1'].mean(), stratxgb['test_f1'].std()))
    print('Mean Precision for XGB is %0.2f with a Standard Deviation of %0.2f' % (stratxgb['test_precision'].mean(), stratxgb['test_precision'].std()))
    print('Mean Recall for XGB is %0.2f with a Standard Deviation of %0.2f' % (stratxgb['test_recall'].mean(), stratxgb['test_recall'].std()))   
