...
def main():
    ...
    inputArgument.add_argument('sourcefolder', help='Add absolute path to the  Dataset folder')
    inputArgument.add_argument('dictionary', help='Add absolute path to dictionary folder, either Bigram, Trigram or Quadgram')
